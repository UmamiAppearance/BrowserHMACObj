 ...
 * @license GPL-3.0
 */
const M=["SHA-1","SHA-256","SHA-384","SHA-512"],x=new class{constructor(t="buffer"){if(!d.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(d.typeList.join(", ")),new TypeError(e)}this.base1=new y("default",t),this.base16=new w("default",t),this.base32_crockford=new b("rfc4648",t),this.base32_rfc3548=new b("rfc3548",t),this.base32_rfc4648=new b("rfc4648",t),this.base32_zbase32=new b("zbase32",t),this.base58=new m("default",t),this.base58_bitcoin=new m("bitcoin",t),this.base58_flickr=new m("flickr",t),this.base64=new v("default",t),this.base64_urlsafe=new v("urlsafe",t),this.base85_adobe=new A("adobe",t),this.base85_ascii=new A("ascii85",t),this.base85_z85=new A("z85",t),this.base91=new E("default",t),this.leb128=new T("default",t),this.byteConverter=new k(t),this.simpleBase={};for(let e=2;e<37;e++)this.simpleBase[`base${e}`]=new B(e,t)}},I=["raw","jwk"];class S{#e=null;#s=null;#i=null;#n=[];#r=null;#a=this.constructor.keyFormats();#o=null;constructor(t){[this.#i,this.#e]=a(t,M),this.#l()}static baseEx=x;static digestmodsAvailable(){return new Set(M)}static keyFormats(){return new Set(I)}static async generateKey(t="",e=!1){return t=a(t,M).at(0),await s(t,e)}static compareDigest(t,e){if(void 0===t||void 0===e)throw new Error("BrowserSHAobj.compareDigest takes exactly two positional arguments.");let s,i;t=x.byteConverter.encode(t,"uint8"),e=x.byteConverter.encode(e,"uint8"),t.byteLength>e.byteLength?(s=t,i=e):(s=e,i=t);const n=s.map(((t,e)=>t===i.at(e)));return Boolean(n.reduce(((t,e)=>t*e)))}static async new(t=null,e=null,s="",i="raw",n=!1){const r=new this(s);return t&&("object"===i?await r.setKey(t):await r.importKey(t,i,n)),null!==e&&(t||(await r.generateKey(),console.warn("A message but no key was provided. The key was generated for you.")),await r.update(e)),r}get digestSize(){return this.#e/8}get blockSize(){return this.#e>256?128:64}get name(){return"HMAC-"+this.#i}#h(t){return x.byteConverter.encode(t,"bytes")}#u(t){if(!this.#a.has(t))throw new TypeError(`Invalid key format '${t}'\n\nValid formats are: ${I.join(", ")}`)}#c(){if(null===this.#r)throw new Error("No key is assigned yet. Import or generate key.")}#d(t,e){const s="Invalid base conversion keyword.";var i;if(i=e.replace(/^to/,""),"hex"===(e=i.charAt(0).toLowerCase().concat(i.slice(1)))||"hexdigest"==e)e="base16";else if("bytes"===e)e="byteConverter";else if(/SimpleBase/i.test(e)){if(!((e="base"+(0|[].concat(String(e).match(/[0-9]+/)).at(0)))in x.simpleBase))throw new TypeError(s);return x.simpleBase[e].encode(t)}if(!(e in x))throw new TypeError(s);return x[e].encode(t)}async update(t,e=!1){t=this.#h(t),this.#c(),this.#n=e?Array.from(t):this.#n.concat(Array.from(t)),this.#s=await n(Uint8Array.from(this.#n),this.#r)}async replace(t){await this.update(t,!0)}async setKey(t){this.#r=t,this.#n.length&&(console.warn("A new crypto key was established. A fresh digest is now getting calculated."),this.#s=await n(Uint8Array.from(this.#n),this.#r))}async importKey(t,s="raw",i=!1){"raw"===s?t=this.#h(t):this.#u(s),this.#o=i;const n=await e(t,this.#i,s,i);await this.setKey(n)}async generateKey(t=!0){this.#o=Boolean(t);const e=await s(this.#i,this.#o);await this.setKey(e)}async exportKey(e="raw"){if(this.#u(e),null===this.#r)throw new Error("Key is unset.");if(!this.#o)throw new t("Key exports are not allowed. You have to permit this before key-generation.");return await i(this.#r,e)}async copy(){return await this.constructor.new(this.#r,this.#n.length?Uint8Array.from(this.#n):null,this.#i,"object",this.#o)}async sign(t,e=null){this.#c(),t=this.#h(t);const s=await n(t,this.#r);return null!==e?this.#d(s,e):s}async verify(t,e){if(t=this.#h(t),this.#c(),null===this.signature)throw new TypeError("Signature must be provided");return await r(t,e,this.#r)}digest(){return this.#s}#l(){const t=(t,e)=>t.splice(t.indexOf(e),1),e=t=>t.charAt(0).toUpperCase().concat(t.slice(1));this.hexdigest=()=>this.#s?x.base16.encode(this.#s):null;const s=Object.keys(x);this.basedigest={toSimpleBase:{}},t(s,"base1"),t(s,"byteConverter"),t(s,"simpleBase");for(const t of s)this.basedigest[`to${e(t)}`]=(...e)=>this.#s?x[t].encode(this.#s,...e):null;for(const t in x.simpleBase)this.basedigest.toSimpleBase[e(t)]=(...e)=>this.#s?x.simpleBase[t].encode(this.#s,...e):null;this.basedigest.toBytes=(...t)=>this.#s?x.byteConverter.encode(this.#s,...t):null}}export{S as default};
